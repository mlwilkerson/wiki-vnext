...
module.exports = {
  Query: {
    async hooks () {
      return WIKI.models.hooks.query()
    },
  ...
  Mutation: {
    ...
    async createHook (obj, args) {
      try {
        ...
        return {
          status: graphHelper.generateSuccess('Hook created successfully'),
          hook: newHook
        }
      } catch (err) {
    ...
    async updateHook (obj, args) {
      try {
        ...
        return {
          status: graphHelper.generateSuccess('Hook updated successfully')
        }
      } catch (err) {
        return graphHelper.generateError(err)
      }
    ...
    async deleteHook (obj, args) {
      try {
        ...
        return {
          status: graphHelper.generateSuccess('Hook deleted successfully')
        }
      } catch (err) {
        return graphHelper.generateError(err)
      }
