    ...
    q-drawer(v-model='leftDrawerOpen', show-if-above, content-class='bg-white', bordered)
      q-scroll-area.admin-nav(
        ...
        q-list.text-grey-8(padding, dense)
          q-item(to='dashboard', v-ripple, active-class='bg-blue-6 text-white')
          ...
          q-item(to='general', v-ripple, active-class='bg-blue-6 text-white')
            q-item-section(avatar)
              q-icon(name='las la-shapes')
            q-item-section {{ $t('admin:general.title') }}
          q-item(to='locale', v-ripple, active-class='bg-blue-6 text-white')
            q-item-section(avatar)
              q-icon(name='las la-language')
            q-item-section {{ $t('admin:locale.title') }}
          q-item(to='navigation', v-ripple, active-class='bg-blue-6 text-white')
            q-item-section(avatar)
              q-icon(name='las la-th-list')
            q-item-section {{ $t('admin:navigation.title') }}
          q-item(to='theme', v-ripple, active-class='bg-blue-6 text-white')
            q-item-section(avatar)
          ...
          q-item(to='groups', v-ripple, active-class='bg-blue-6 text-white')
            q-item-section(avatar)
              q-icon(name='las la-users')
            q-item-section {{ $t('admin:groups.title') }}
            q-item-section(side)
              q-badge(color='grey', :label='info.groupsTotal')
          q-item(to='users', v-ripple, active-class='bg-blue-6 text-white')
            q-item-section(avatar)
          ...
          q-item(to='analytics', v-ripple, active-class='bg-blue-6 text-white')
            q-item-section(avatar)
              q-icon(name='las la-chart-line')
            q-item-section {{ $t('admin:analytics.title') }}
          q-item(to='auth', v-ripple, active-class='bg-blue-6 text-white')
            q-item-section(avatar)
              q-icon(name='las la-lock')
            q-item-section {{ $t('admin:auth.title') }}
          q-item(to='comments', v-ripple, active-class='bg-blue-6 text-white')
            q-item-section(avatar)
              q-icon(name='las la-comment')
            q-item-section {{ $t('admin:comments.title') }}
          q-item(to='editor', v-ripple, active-class='bg-blue-6 text-white')
            q-item-section(avatar)
              q-icon(name='las la-pen-square')
            q-item-section {{ $t('admin:editor.title') }}
          q-item(to='extensions', v-ripple, active-class='bg-blue-6 text-white')
            q-item-section(avatar)
              q-icon(name='las la-puzzle-piece')
            q-item-section {{ $t('admin:extensions.title') }}
          q-item(to='rendering', v-ripple, active-class='bg-blue-6 text-white')
            q-item-section(avatar)
              q-icon(name='las la-cogs')
            q-item-section {{ $t('admin:rendering.title') }}
          q-item(to='search', v-ripple, active-class='bg-blue-6 text-white')
            q-item-section(avatar)
              q-icon(name='las la-search')
            q-item-section {{ $t('admin:search.title') }}
          q-item(to='storage', v-ripple, active-class='bg-blue-6 text-white')
            q-item-section(avatar)
          ...
          q-item(to='api', v-ripple, active-class='bg-blue-6 text-white')
            q-item-section(avatar)
              q-icon(name='las la-dharmachakra')
            q-item-section {{ $t('admin:api.title') }}
          q-item(to='mail', v-ripple, active-class='bg-blue-6 text-white')
            q-item-section(avatar)
              q-icon(name='las la-mail-bulk')
            q-item-section {{ $t('admin:mail.title') }}
          q-item(to='security', v-ripple, active-class='bg-blue-6 text-white')
            q-item-section(avatar)
              q-icon(name='las la-shield-alt')
            q-item-section {{ $t('admin:security.title') }}
          q-item(to='ssl', v-ripple, active-class='bg-blue-6 text-white')
            q-item-section(avatar)
              q-icon(name='las la-key')
            q-item-section {{ $t('admin:ssl.title') }}
          q-item(to='system', v-ripple, active-class='bg-blue-6 text-white')
            q-item-section(avatar)
              q-icon(name='las la-sliders-h')
            q-item-section {{ $t('admin:system.title') }}
          q-item(to='utilities', v-ripple, active-class='bg-blue-6 text-white')
            q-item-section(avatar)
              q-icon(name='las la-screwdriver')
            q-item-section {{ $t('admin:utilities.title') }}
          q-item(to='webhooks', v-ripple, active-class='bg-blue-6 text-white')
            q-item-section(avatar)
              q-icon(name='las la-magic')
            q-item-section {{ $t('admin:webhooks.title') }}
          q-item(to='dev-flags', v-ripple, active-class='bg-blue-6 text-white')
            q-item-section(avatar)
              q-icon(name='las la-flag-checkered')
            q-item-section {{ $t('admin:dev.flags.title') }}
          q-separator(spaced, inset)
          q-item(to='contribute', v-ripple, active-class='bg-blue-6 text-white')
            q-item-section(avatar)
